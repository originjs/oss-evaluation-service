...
(
    ...
    start_time        datetime                            not null comment 'task开启时间',
    end_time          datetime                            null comment 'task结束时间',
    ...
    task_exception    mediumint                           null comment 'task的异常',
    ...
    constraint schedule_task_monitor_pk
        primary key (id)
)
